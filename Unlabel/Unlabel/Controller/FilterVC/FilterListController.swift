...
//   MARK:- Life Cycle methods
   ...
   private func setUp() {
      ...
      self.IBtableFilterList.separatorColor =  UIColor(red: 69/255, green: 73/255, blue: 78/255, alpha: 0.6)   // MEDIUM_GRAY_TEXT_COLOR
...
//      cell.textLabel?.font = UIFont(name: "Neutraface2Text-Demi", size: 15)
